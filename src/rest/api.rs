...
impl RestClient {
    ...
    /// Fetch channels for a guild (GET /guilds/{id}/channels).
    pub async fn fetch_guild_channels(&self, guild_id: u64) -> anyhow::Result<Vec<Value>> {
        ...
        debug!("Fetched {} channels for guild {}", body.len(), guild_id);
        Ok(body)
    }
